...
export default function AyudaPopup({ onClose }) {
  ...
  return (
      <div className={`ayuda-overlay ${cerrando ? 'ayuda-overlay--saliendo' : ''}`} onClick={handleClose}>
        <div className={`ayuda-modal ${cerrando ? 'ayuda-modal--saliendo' : ''}`} onClick={e => e.stopPropagation()}>
          ...
          <button className="ayuda-modal__btn" onClick={handleClose}>
            Entendido
          </button>
