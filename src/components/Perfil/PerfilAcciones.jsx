  ...
  return (
      <div className="perfil-acciones">
        <div className="perfil-acciones__botones">
          ...
          >
            <img src="/dashboardIcon.png" alt="Dashboard" className="perfil-acciones__btn-img" />
            Volver al dashboard
          </button>
          <button
          ...
          >
            <img src="/cerrarIcon.png" alt="Cerrar sesión" className="perfil-acciones__btn-img" />
            Cerrar sesión
          </button>
        </div>

        <div className="perfil-acciones__infobox">
          <img src="/cerebroIcon.png" alt="IA" className="perfil-acciones__infobox-icon" />
