    ...
    <div className="moodle-banner">
      <div className="moodle-banner__inner">
        ...
        <div className="moodle-banner__item moodle-banner__item--main">
          <img src="/LogoMoodle.png" alt="Moodle" className="moodle-banner__icon moodle-banner__icon--lg" />
          <div>
        ...
        <div className="moodle-banner__item">
          <img src="/accesoIcono.png" alt="Acceso seguro" className="moodle-banner__icon" />
          <div>
        ...
        <div className="moodle-banner__item">
          <img src="/SincronizacionIcono.png" alt="Sincronización" className="moodle-banner__icon" />
          <div>
        ...
        <div className="moodle-banner__item">
          <img src="/resultadosIcono.png" alt="Resultados" className="moodle-banner__icon" />
          <div>
